...
<div class="flex">
    ...
    <div class="px-5 py-10 w-10/12">
        <div class="mt-7 font-bold text-3xl">Daftar Mahasiswa Baru</div>
        @if (count($errors) > 0)
      ...
      @endif
        ...
        @endif
        <form action="{{route('dashboard.daftar_post')}}" method="post" class="mt-5" enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div class="flex flex-col w-1/2">
                <div class="mt-2 w-full space-y-2">
                    ...
                    <input type="text" name="nama_lengkap" value="{{old('nama_lengkap')}}" class="border border-black px-3 py-2 w-full" placeholder="Nama Lengkap">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Alamat KTP</div>
                    <input type="text" name="alamat_ktp" value="{{old('alamat_ktp')}}" class="border border-black px-3 py-2 w-full" placeholder="Alamat KTP">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Alamat Saat Ini</div>
                    <input type="text" name="alamat_sekarang" value="{{old('alamat_sekarang')}}" class="border border-black px-3 py-2 w-full" placeholder="Alamat Saat Ini">
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Kecamatan</div>
                    <input type="text" name="kecamatan" value="{{old('kecamatan')}}" class="border border-black px-3 py-2 w-full" placeholder="Kecamatan">
                </div>
                <div class="mt-2 w-full space-y-2">
                ...
                <div class="mt-2 w-full space-y-2">
                    ...
                    <input type="number" name="noTelp" value="{{old('noTelp')}}" class="border border-black px-3 py-2 w-full" placeholder="Nomor Telepon">                    
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Nomor HP</div>
                    <input type="number" name="noHp" value="{{old('noHp')}}" class="border border-black px-3 py-2 w-full" placeholder="Nomor HP">                    
                </div>
                <div class="mt-2 w-full space-y-2">
                    <div class="">Email</div>
                    <input type="email" name="email" value="{{old('email')}}" class="border border-black px-3 py-2 w-full" placeholder="Email">
                </div>
                <div class="mt-2 w-full space-y-2">
                ...
                <div class="mt-2 w-full space-y-2">
                    ...
                    <input type="date" name="tgl_lahir" value="{{old('tgl_lahir')}}" class="border border-black px-3 py-2 w-full" placeholder="Tanggal Lahir">
                </div>
                <div class="mt-2 w-full space-y-2">
                ...
                <div class="mt-2 w-full space-y-2">
                    ...
                    <input type="text" name="negara_lahir" value="{{old('negara_lahir')}}" class="border border-black px-3 py-2 w-full" placeholder="Negara Lahir">
                </div>
                <div class="mt-2 w-full space-y-2">
                ...
                <button type="submit">
                    <div class="border border-black px-10 py-2 mt-5 w-full text-center bg-white hover:bg-slate-800 hover:text-white">Daftar</div>
                </button>
            </div>
        </form>
    </div>
